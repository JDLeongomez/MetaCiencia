...
::: {.callout-note}
## Conceptos clave
Algunos conceptos usados en esta página: [Quarto](../glosario/terminos/quarto/index.qmd), [R / RStudio](../glosario/terminos/r-rstudio/index.qmd).
:::
...
Puedes usar cualquier editor, pero recomendamos **[RStudio](../glosario/terminos/r-rstudio/index.qmd)** o **VS Code**, porque ambos tienen soporte nativo para Quarto (resaltado de sintaxis, previsualización integrada, etc.).
...
![](../assets/logo_MetaCiencia.svg){width="80px"}
:::
